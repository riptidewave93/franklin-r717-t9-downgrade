...
OTA_FILE="https://snt.sh/uploads/t9/T9_1311_ota_update_all_block_otas.zip"
OTA_SUM="c20f5db25dfa3f5954ff0f9e233d42e4"

# Make sure we have internets
...
echo "Downloading downgrade image"
wget -O /cache/ota_update_all.zip "${OTA_FILE}"
